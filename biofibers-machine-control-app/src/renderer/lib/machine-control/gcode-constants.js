...
export const CMD_REPORT_TEMPERATURES_IMMEDIATELY = 'M105';
export const CMD_REPORT_TEMPERATURES_INTERVAL = 'M155';
export const DEFAULT_REPORT_TEMPERATURE_INTERVAL = 5;   // in seconds

...
module.exports = merge(base, {
  ...
  devServer: {
    ...
    static: {
      directory: path.resolve(__dirname, "../biofibers-machine-control-app/src/dist"), // Where we serve the local dev server's files from
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: path.resolve(__dirname, "biofibers-machine-control-app/src/index.html"),
      filename: "index.html"
    }),
